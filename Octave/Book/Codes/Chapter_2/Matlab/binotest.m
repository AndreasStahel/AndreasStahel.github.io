...
%[h, pval, ci] = binotest (pos,N,p0)
%[h, pval, ci] = binotest (pos,N,p0,Name,Value)
...
% alternative p != p0. The value of pval is determined by adding the
% probabilities of all event less or equally likely than the observed 
% number pos of positive events.
% If the value of "tail" is "right" the one-sided alternative p > p0
% is considered.
% Similarly for "left", the one-sided alternative p < p0 is considered.
% h is 0 the null hypothesis is accepted, if it is 1 the null hypothesis is rejected.
% The p-value of the test is returned in pval.
% A 100(1-alpha)% confidence interval is returned in ci.

% this version of binotest works with Matlab and Octave
% for Octave use the version in the package statistics  
